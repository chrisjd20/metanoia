...
| **The Holy Grail** | The Market (Gluttony) | The sacred chalice that held the Blood of Christ, concealed inside a desecrated tabernacle amid grotesque excess. The true vessel of nourishment, hidden where consumption is disordered and endless. | Eucharist effects (Nodes and Drops) restore 25% more Grace. Fervor generation from freeing souls increased by 15%. |
